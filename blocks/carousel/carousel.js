...
/**
 * Updates the active slide in the carousel block.
 * @param {HTMLElement} slide - Current slide element.
 */
...
/**
 * Displays the selected slide with smooth scrolling.
 * @param {HTMLElement} block - Carousel block.
 * @param {number} [slideIndex=0] - Index of the slide to display.
 */
...
/**
 * Creates a slide for the carousel.
...
/**
 * Initialize and decorate the carousel block.
 * @param {HTMLElement} block - Carousel block.
 */
